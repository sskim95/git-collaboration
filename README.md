...
"Applying this commit will ....".  For example "Add intro and project for Bro. Slade".  Notice, you do not include "Applying this commit will".  You will get marked down if you do not have the right commit message.
8. Push your changes to the origin (the origin the the forked version of the original repo on GitHub. The upstream is the original repo that you forked.)
9. Visit the URL that you get on the command line to submit a Pull Request.
